...
@Component({
  ...
  templateUrl: './lista-chamados-filiais.component.html',
  styleUrl: './lista-chamados-filiais.component.scss'
})
export class ListaFiliaisComponent implements OnInit, OnDestroy {
 datauser: any;
  ...
  gerar() {
    ...
    this.minhaSubscription = this.service.ListaAdmFiliais(this.totalPages, this.ativo,data.dataAntes,data.dataDepois,this.size).subscribe((e) => {

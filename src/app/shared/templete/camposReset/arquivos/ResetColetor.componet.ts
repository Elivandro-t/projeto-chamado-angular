...
export class ResetColetorComponent implements OnInit {
  ...
  isGm() {
    return this.myForm.get('gmid')?.errors?.['required'] && this.myForm.get('gmid')?.touched;
  }
  isCPF() {
    return this.myForm.get('cpf')?.errors?.['required'] && this.myForm.get('cpf')?.touched;
  }
  isFilial() {
    return this.myForm.get('filial')?.errors?.['maxlength'] && this.myForm.get('filial')?.touched;
  }
  isFilialRe() {
    return this.myForm.get('filial')?.errors?.['required'] && this.myForm.get('filial')?.touched;
  }
  isFilialRequired() {
    return this.myForm.get('filial')?.errors?.['pattern'] && this.myForm.get('filial')?.touched;
  }
  isNasc() {
    return this.myForm.get('dataNasc')?.errors?.['required'] && this.myForm.get('dataNasc')?.touched;
  }
  isAdmin() {
    return this.myForm.get('dataAdmin')?.errors?.['required'] && this.myForm.get('dataAdmin')?.touched;
  }
  isFuncao() {
    return this.myForm.get('funcao')?.errors?.['required'] && this.myForm.get('funcao')?.touched;
  }
}